    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer__navigation">
          {footerLinks.map(({ category, links }, index) => (
            <FooterMenu
              ...
              index={index}
              title={category}
              isOpen={mobileItemOpen === index}
              handleItemClick={toggleMobileItem}
              links={links}
            />
          ))}
        </div>
        ...
        <div className="footer__social">
          <p>Siga a gente</p>
          <a
            href="https://www.facebook.com/iqcontas/"
            target="_blank"
            rel="noopener"
            data-clicked="btn-social-midia-facebook"
          ...
          <a
            href="https://www.instagram.com/iqbrasil/"
            target="_blank"
            rel="noopener"
            data-clicked="btn-social-midia-instagram"
            className="footer__social__link"
          ...
          <a
            href="https://www.youtube.com/channel/UC9aMCgvaLRijZ1rddTKSxYA"
            target="_blank"
            rel="noopener"
            data-clicked="btn-social-midia-youtube"
            className="footer__social__link"
          ...
          <a
            href="https://www.linkedin.com/company/iq360/"
            target="_blank"
            rel="noopener"
            data-clicked="btn-social-midia-linkedin"
            className="footer__social__link"
            title="Acompanhe nossa página no LinkedIn"
          >
            {/* <Icon id={'ic-linkedin'} /> */}
          </a>
          <a
            href="https://www.tiktok.com/@iqbrasil"
            target="_blank"
            rel="noopener"
            data-clicked="btn-social-midia-tiktok"
            className="footer__social__link"
            title="Veja nossos vídeos no Tiktok"
          >
            {/* <Icon id={'ic-tiktok'} /> */}
          </a>
        </div>
