...
const HamburgerButton = () => {
  return <button className="header-classic__hamburger">toggle</button>;
};

const LoggoutOutNavigation = () => {
  return <nav></nav>;
};
...
const HeaderClassic: React.FC<HeaderClassicProps> = ({ isLogged = false }) => {
  ...
  const { unloggedMenuItems, goToHomePage } = useClassicHeader({ isLogged });
